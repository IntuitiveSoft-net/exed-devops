...
- name: Deploy devops website
  ...
  - name: change index.html
    ansible.builtin.copy:
      ...
      dest: /var/www/devops/index.html
      mode: '0775'
      owner: "{{ ansible_user }}"
      group: "{{ ansible_user }}"
    become: true
...
## Task 5. Deploy certificate for your host
...
## Task 6. Visualize the NGINX configuration file
...
```bash
ansible nginx -i inventory.ini --module-name command -a "cat /etc/nginx/sites-enabled/devops"
```
