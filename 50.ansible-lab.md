...
Install pipx and requirements

```bash
sudo apt install pipx python3.8-venv python3-pip
```
...
```bash
cp -R ~/lab/ansible-project ~/work/ansible-nginx
```
...
## Task 13. Create a DNS entry for your NGINX VM 
