...
Let's first remove your terraform state file. By doing this terraform loses the state of you infrastructure. 

```console
rm terraform.tfstate 
```

If you were to use `terraform apply`, terraform would have to create a new instance of your subnet and would fail as there will be an overlap on the cidr_block.

Instead let's instruct terraform to `import` the previously created AWS subnet into terraform.

```console
terraform import aws_subnet.example subnet-0783f8621ad659e83
```
