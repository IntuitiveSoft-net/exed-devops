# 21. AWS Introduction VPC EC2 lab
...
Connect to the AWS management console using the training SSO portal : 
 ...
 __https://intuitivesoft.awsapps.com/start#/__
...
> :warning: **This is a shared lab environment**. During this training you will be instructed to create,edit,delete AWS ressources. AWS provides a `tag` system to help you filter through ressources with you tag convention. Use it as a best practice to differentiate from other lab environment.  
___ 
...
## Task 2. Visualize your user permissions
...
Your user is assigned to role `AWSReservedSSO_DevopsLab_XXXXXXXXXXXXXXXX` navigate to the role and visualise the permissions attached to your role. 

**- Task 2.3 -**

You are a PowerUser you have `Full access` to most of AWS ressources but some restrictions on some services such as `IAM`. Filter the permissions attached to service `IAM`, you have limited `Read,Write`

![](./images/aws_iam.png)

## Task 3. AWS Policy 

The graphical interface representation is usefull to have an overview. You can switch to the declarative representaion of the policy by clicking `JSON`
...
## Task 7. Create a Public and Private subnet.
...
Navigate to the VPC > Subnet section, or using the following link [https://us-east-1.console.aws.amazon.com/vpc/home?region=us-east-1#subnets:](https://us-east-1.console.aws.amazon.com/vpc/home?region=us-east-1#subnets:)
...
## Task 9. Add an Internet Gateway to you VPC

**- Task 9.1 -**

Navigate to the `VPC > Internet Gateway`` , or using the following link [https://us-east-1.console.aws.amazon.com/vpc/home?region=us-east-1#igws:](https://us-east-1.console.aws.amazon.com/vpc/home?region=us-east-1#igws:)
...
Navigate to the `VPC > Route Tables` , or using the following link [https://us-east-1.console.aws.amazon.com/vpc/home?region=us-east-1#RouteTables:](https://us-east-1.console.aws.amazon.com/vpc/home?region=us-east-1#RouteTables:)

**- Task 10.2 -**

Create a new `route table` attached to public subnet

**- Task 10.3 -**

Update the new `route table` of your VPC and add a route to route traffic to internet.
...
Navigate to the `VPC > Security Groups` , or using the following link [https://us-east-1.console.aws.amazon.com/vpc/home?region=us-east-1#SecurityGroups:](https://us-east-1.console.aws.amazon.com/vpc/home?region=us-east-1#SecurityGroups:)

**- Task 11.2 -**

Create a `VPC security group` to allow SSH connection from Internet.
